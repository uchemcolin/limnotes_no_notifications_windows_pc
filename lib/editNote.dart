...
class _EditNotePageState extends State<EditNotePage> {
  ...
  TextEditingController titleTextFormFieldController = TextEditingController(); //set the initial value of the title text field to the initial one of the note to be edited

  TextEditingController bodyTextFormFieldController = TextEditingController(); //set the initial value of the body text field to the initial one of the note to be edited
  ...
  void saveNoteFunction() async {
    ...
    if(finalTitle.isNotEmpty == true || finalBody.isNotEmpty == true) {
      ...
      Navigator.pushReplacement(
        context,
        FluentPageRoute(builder: (context) => const MyHomePage()),
      );
